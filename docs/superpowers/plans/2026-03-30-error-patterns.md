# Error Patterns Documentation Page — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a new Foundations documentation page teaching when to use Result types and when not to, with 7 good/bad code patterns aimed at both human developers and AI coding agents.

**Architecture:** Single Markdown page at `apps/docs-site/src/content/docs/foundations/error-patterns.md` plus a one-line sidebar entry in `astro.config.mjs`. No new components, no MDX needed.

**Tech Stack:** Astro/Starlight docs site, Markdown, TypeScript code examples

---

### Task 1: Create the error-patterns.md documentation page

**Files:**
- Create: `apps/docs-site/src/content/docs/foundations/error-patterns.md`

- [ ] **Step 1: Create the page file**

Create `apps/docs-site/src/content/docs/foundations/error-patterns.md` with this content:
...
Run: `cat apps/docs-site/src/content/docs/foundations/error-patterns.md | head -5`
...
```bash
git add apps/docs-site/src/content/docs/foundations/error-patterns.md
git commit -m "docs: add error patterns page to foundations"
```

---

### Task 2: Add sidebar entry in astro.config.mjs

**Files:**
- Modify: `apps/docs-site/astro.config.mjs:69` (after Tagged Errors entry)

- [ ] **Step 1: Add the sidebar entry**

In `apps/docs-site/astro.config.mjs`, find this line:
...
- [ ] **Step 2: Verify the sidebar config**

Run: `grep -A1 'Tagged Errors' apps/docs-site/astro.config.mjs`
...
git commit -m "docs: add error patterns to foundations sidebar"
```

---

### Task 3: Verify the docs site builds

**Files:**
- None (verification only)

- [ ] **Step 1: Run the docs site build**

Run from repo root: `cd apps/docs-site && npm run build`

Expected: Build completes without errors. The new page appears in the output as a generated route.

- [ ] **Step 2: Verify the page is in the build output**

Run: `find apps/docs-site/dist -path '*error-patterns*' -type f`

Expected: At least one HTML file matching `error-patterns`.
...
```bash
git add -A
git commit -m "docs: fix error patterns page build issues"
```

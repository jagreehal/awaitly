      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Loops and Early Returns', slug: 'foundations/loops-and-early-returns' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Errors Across the Wire', slug: 'guides/errors-across-the-wire' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Agent Skills', slug: 'guides/claude-skill' },

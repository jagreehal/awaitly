...
<CardGrid>
  ...
  <Card title="flow()" icon="branch">
    Effect.gen-like composition using plain async/await, with inferred errors and lightweight step tracking.

    [Learn flow() →](foundations/flow/)
  </Card>
...
| `flow(deps, body)` | Effect.gen-like API with async/await and inferred errors |

...
1. **Visible**: can you see every way the code can fail by reading it?
...
Pick the one that fits the failure modes your code has, and the amount of structure your team wants to maintain.

...
- Updated dependencies [9bc63bf]
  - awaitly@6.2.0
  - awaitly-visualizer@36.0.0
...
- Updated dependencies [8f6e419]
  - awaitly@6.1.0
  - awaitly-visualizer@35.0.0

## 0.30.1

### Patch Changes

- Updated dependencies [3d332a8]
- Updated dependencies [7e8fdfd]
- Updated dependencies [7e8fdfd]
  - awaitly@6.0.0
  - awaitly-visualizer@34.0.0

## 0.30.0

### Minor Changes

- 94bef4c: Per-iteration checkpoints for `step.forEach`, crash retry on resume, and static analysis of `durable.run`.
  ...
  **`resumeFailedSteps` decides what a resume restores.** A step that failed by _throwing_
...
- Updated dependencies [94bef4c]
  - awaitly@5.0.0
  - awaitly-visualizer@33.0.0

## 0.29.3

### Patch Changes

- Updated dependencies [7d25be3]
  - awaitly@4.5.1
...
- Updated dependencies [2655501]
  - awaitly@4.4.0
  - awaitly-visualizer@31.0.0

## 0.29.0

### Minor Changes

- 8295850: A DX pass over retry ergonomics, saga rollbacks, Standard Schema typing, and static-analysis output.
...
- Updated dependencies [8295850]
  - awaitly@4.3.0
  - awaitly-visualizer@30.0.0

## 0.28.2

### Patch Changes

- Updated dependencies [a2c8cf1]
  - awaitly@4.2.0
  - awaitly-visualizer@29.0.0
...
- Updated dependencies [75a016e]
- Updated dependencies [da2f3e3]
  - awaitly@4.0.0
  - awaitly-visualizer@27.0.0
...
- 8b2d264: Improve CLI defaults by auto-selecting the most useful diagram type when no explicit format is provided.

  Add workflow-aware auto-detection between railway and mermaid output, expose the new diagram inference helper, and add a `--watch` mode for live re-analysis during editing.
...
- Updated dependencies [102e866]
  - awaitly-visualizer@18.1.0
